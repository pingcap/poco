...
namespace Poco {
[[maybe_unused]] static BLAKE2_INLINE uint32_t load32(const void *src)
{
...
[[maybe_unused]] static BLAKE2_INLINE uint16_t load16(const void *src)
{
#if defined(POCO_ARCH_LITTLE_ENDIAN)
	uint16_t w;
	memcpy(&w, src, sizeof w);
...
[[maybe_unused]] static BLAKE2_INLINE void store16(void *dst, uint16_t w)
{
#if defined(POCO_ARCH_LITTLE_ENDIAN)
...
[[maybe_unused]] static BLAKE2_INLINE uint64_t load48(const void *src)
{
...
[[maybe_unused]] static BLAKE2_INLINE void store48(void *dst, uint64_t w)
{
...
[[maybe_unused]] static BLAKE2_INLINE uint32_t rotr32(const uint32_t w, const unsigned c)
{
	return (w >> c) | (w << (32 - c));
}
